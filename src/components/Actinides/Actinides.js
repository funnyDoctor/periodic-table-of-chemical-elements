...
import actinides from '../../data/actinides';


class Actinides extends React.Component {
    constructor(props) {
        super(props);
        this.state = {properties: actinides.properties}
    }
    render() {
        const properties = this.state.properties;
        return (
            <Fragment>
                    <div className={'box box--right color'}>
                    ...
                    <div className={'box box--right color'}>
                        ...
                        <div className={'box__title'}>
                            <h3 className={'box__title--heading size'}>{properties[2].title}</h3>
                        </div>
                        <div className={'box__number'}>
                    ...
                    <div className={'box box--right color'}>
                        ...
                        <div className={'box__title'}>
                            <h3 className={'box__title--heading size'}>{properties[9].title}</h3>
                        </div>
                        <div className={'box__number'}>
                    ...
                    <div className={'box box--right color'}>
                        ...
                        <div className={'box__title'}>
                            <h3 className={'box__title--heading size'}>{properties[10].title}</h3>
                        </div>
                        <div className={'box__number'}>
                    ...
                    <div className={'box box--right color'}>
                        ...
                        <div className={'box__title'}>
                            <h3 className={'box__title--heading size'}>{properties[12].title}</h3>
                        </div>
                        <div className={'box__number'}>
